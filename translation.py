class Translation(object):
    START_TEXT = """Hi l_s_meena {} 😂,
Myself l_s_url i'm devloped in india 
...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thank you <a href='https://t.me/movie_studio_2023'>**L_S_MEENA**</a> for helping us in this journey ❤️"
...
Contact ADMIN if any error occurs @CHATWITHANOTHERbot"""
    ...
    LAZY_START_TEXT = """𝙷𝚎𝚕𝚕𝚘 DARLING {},

𝗬𝗼𝘂 𝗺𝘂𝘀𝘁 𝗯𝗲 𝗮𝗻 𝗔𝘂𝘁𝗵𝗲𝗻𝘁𝗶𝗰 𝗨𝘀𝗲𝗿 𝘁𝗼 𝘂𝘀𝗲 𝗺𝗲.
The L_S_MEENA has not allowed me to upload files from the urls which is send by an unAuthorised member.

Please contact my Developer to be an authorised user ! 
"""
    L_S_MEENA_TEXT = """▍║▍▏║ Hello Dear ADMIN ║▍▏║▍
⭑┗┫⦀⦙ {} ⦙⦀┣┛⭑
